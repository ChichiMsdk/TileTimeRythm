...
INCLUDE_DIRS	=-Isrc -Isrc/engine -Isrc/engine/core -Ithirdparty
LIB_PATH		=
LIBS			=

SRC_DIR			=src
SHADER_DIR		=$(SRC_DIR)/engine/shaders
CORE_DIR		=$(SRC_DIR)/engine/core
RENDERER_DIR	=$(SRC_DIR)/engine/renderer
WIN32_DIR		=$(SRC_DIR)/engine/win32
LINUX_DIR		=$(SRC_DIR)/engine/linux
APPLE_DIR		=$(SRC_DIR)/engine/apple
...
all: $(OBJ_DIR) $(BUILD_DIR)/$(OUTPUT) $(SHADER_OBJS)
