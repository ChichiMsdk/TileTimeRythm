...
const char *gppShaderFilePath[] = {
	"./build/obj/engine/shaders/gradient_color.comp.spv",
	"./build/obj/engine/shaders/gradient.comp.spv",
	"./build/obj/engine/shaders/sky.comp.spv",
};
...
AppConfig gAppConfig = { .pAppName = "TileTimeRythm", .x = 100, .y = 100, .w = 1500, .h = 900, };
OsState gOsState = {0};
